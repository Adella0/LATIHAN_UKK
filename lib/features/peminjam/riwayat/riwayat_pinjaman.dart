...
class _RiwayatPeminjamanScreenState extends State<RiwayatPeminjamanScreen> {
  // Data dummy untuk tampilan Riwayat sesuai gambar image_fc8c19.png
  final List<Map<String, dynamic>> _riwayatData = [
    {
      'nama': 'Monica',
      'tanggal': '12/01/2026',
      'status': 'Ditolak',
      'color': const Color(0xFFE52121), // Merah
    },
    {
      'nama': 'Monica',
      'tanggal': '12/01/2026',
      'status': 'Selesai',
      'color': const Color(0xFF4B4B4B), // Abu-abu gelap/hitam sesuai gambar
    },
  ];
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFFD1D8E0), // Abu-abu kebiruan
