...
class _DetailDendaPageState extends State<DetailDendaPage> {
 ...
 Widget _buildDayFilter() {
    ...
    return Container(
      height: 70, // Sedikit diperpendek agar lebih padat
      margin: const EdgeInsets.symmetric(vertical: 10),
      child: ListView.builder(
        // INI KUNCINYA: Memastikan scroll ke samping aktif
        scrollDirection: Axis.horizontal, 
        physics: const BouncingScrollPhysics(), // Memberikan efek pantul saat di-scroll
        padding: const EdgeInsets.symmetric(horizontal: 15),
        itemCount: 7,
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            ...
            child: Container(
              width: 65, // Lebar kotak sedikit ditambah agar lebih mudah ditekan
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: isSelected 
                  ? [BoxShadow(color: const Color(0xFF0D1B3E).withOpacity(0.3), blurRadius: 8, offset: const Offset(0, 4))] 
                  : [],
              ),
              child: Center( // Menggunakan Center agar teks benar-benar di tengah
                child: Text(
                  _hariNama[index],
